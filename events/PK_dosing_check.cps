...
<!-- generated with COPASI 4.36.260 (Source) (http://www.copasi.org) at 2022-08-02T14:13:52Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_39" name="Rate Law for drug_transport" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_264" name="drug1_p" order="0" role="substrate"/>
        <ParameterDescription key="FunctionParameter_263" name="drug1_c" order="1" role="product"/>
        <ParameterDescription key="FunctionParameter_262" name="k" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_2" name="PDynamics" simulationType="time" timeUnit="min" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221407599999999e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_2">
    ...
    <ListOfCompartments>
      <Compartment key="Compartment_2" name="Vc" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </Compartment>
      <Compartment key="Compartment_3" name="Vp" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </Compartment>
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_2" name="drug1_p" simulationType="reactions" compartment="Compartment_3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </Metabolite>
      <Metabolite key="Metabolite_3" name="drug1_c" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
      </Metabolite>
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
    ...
    <ListOfReactions>
      <Reaction key="Reaction_2" name="drug_transport" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7689" name="k" value="0.0008"/>
        </ListOfConstants>
        <KineticLaw function="Function_39" unitType="ConcentrationPerTime" scalingCompartment="CN=Root,Model=PDynamics,Vector=Compartments[Vc]">
      ...
      <Reaction key="Reaction_3" name="drug_decay" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" />
        </MiriamAnnotation>
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_7687" name="k1" value="0.0001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=PDynamics,Vector=Compartments[Vc]">
          <ListOfCallParameters>
    ...
    <ListOfEvents>
      <Event key="Event_5" name="event_0" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
...
<rdf:Description rdf:about="#Event_5">
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=PDynamics,Reference=Time> > 0
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c]" targetKey="Metabolite_3">
            <Expression>
              &lt;CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c],Reference=Concentration>+100
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
      <Event key="Event_6" name="event_1" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Event_6">
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=PDynamics,Reference=Time> > 360
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c]" targetKey="Metabolite_3">
            <Expression>
      ...
      <Event key="Event_7" name="event_2" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Event_7">
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=PDynamics,Reference=Time> > 720
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c]" targetKey="Metabolite_3">
            <Expression>
      ...
      <Event key="Event_8" name="event_3" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Event_8">
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=PDynamics,Reference=Time> > 1080
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c]" targetKey="Metabolite_3">
            <Expression>
              &lt;CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c],Reference=Concentration>+10
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
      <Event key="Event_9" name="event_4" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Event_9">
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=PDynamics,Reference=Time> > 1440
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c]" targetKey="Metabolite_3">
            <Expression>
...
<rdf:Description rdf:about="#ModelParameterSet_2">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=PDynamics" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=PDynamics,Vector=Compartments[Vc]" value="10" type="Compartment" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=PDynamics,Vector=Compartments[Vp]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=PDynamics,Vector=Values[k]" value="0.00080000000000000004" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=PDynamics,Vector=Reactions[drug_transport]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=PDynamics,Vector=Reactions[drug_transport],ParameterGroup=Parameters,Parameter=k" value="0.00080000000000000004" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=PDynamics,Vector=Values[k],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=PDynamics,Vector=Reactions[drug_decay]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=PDynamics,Vector=Reactions[drug_decay],ParameterGroup=Parameters,Parameter=k1" value="0.0001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=PDynamics,Vector=Values[lambda],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_29" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="StepSize" type="float" value="14.5"/>
        <Parameter name="Duration" type="float" value="1450"/>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=PDynamics,Vector=Values[lambda],Reference=InitialValue"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="[drug1_p]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=PDynamics,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=PDynamics,Vector=Compartments[Vp],Vector=Metabolites[drug1_p],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[drug1_c]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=PDynamics,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=PDynamics,Vector=Compartments[Vc],Vector=Metabolites[drug1_c],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
  </ListOfPlots>
  <SBMLReference file="PK_dosing_check.xml">
    <SBMLMap SBMLid="Rate_Law_for_drug_transport" COPASIkey="Function_39"/>
    <SBMLMap SBMLid="Vp" COPASIkey="Compartment_3"/>
    <SBMLMap SBMLid="drug1" COPASIkey="Metabolite_2"/>
    <SBMLMap SBMLid="drug1_c" COPASIkey="Metabolite_3"/>
    <SBMLMap SBMLid="drug_decay" COPASIkey="Reaction_3"/>
    <SBMLMap SBMLid="drug_transport" COPASIkey="Reaction_2"/>
    <SBMLMap SBMLid="k" COPASIkey="ModelValue_3"/>
    <SBMLMap SBMLid="linear_metabolism_rate" COPASIkey="ModelValue_2"/>
    <SBMLMap SBMLid="volume" COPASIkey="Compartment_2"/>
  </SBMLReference>
